...
public class ProductCountHandler extends ProcessHandler {

	private final String DATABASE_TABLE = "products";
	private final static String SELLER_ID_KEY = "seller_id";
	private final static String[] keys = { SELLER_ID_KEY };

	public ProductCountHandler( Map< String, String[] > params ) {
	...
	private ResultCode checkParams()
		...
		if ( adapter.doesExist( DATABASE_TABLE, params ) ) {
			return ResultCode.PRODUCT_COUNT_OK;
		}
